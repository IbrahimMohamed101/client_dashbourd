...
import type { MenuProduct, MenuProductListParams } from "@/types/menuTypes";
import { CatalogNutritionTab } from "../catalog-items/CatalogNutritionTab";
...
export function MenuProductsTab({ canWrite = true }: { canWrite?: boolean }) {
  ...
  return (
    <div className="grid gap-5">
      ...
      />
      <CatalogNutritionTab canWrite={canWrite} />
    </div>
  );
}
