...
export function PromoCodeSection({
  ...
  return (
    <Card data-testid="promo-code-section">
      <CardHeader>
        ...
        <CardDescription>
          اختياري — طبّق الكود بعد اختيار الباقة والتوصيل، وسيظهر السعر النهائي في إجمالي الاشتراك بالأسفل.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-3">
        ...
        {promoResult ? (
          <div className="flex items-center gap-2 rounded-lg border border-emerald-500/30 bg-emerald-500/10 p-3 text-sm font-semibold text-emerald-700 dark:text-emerald-300">
            <CheckCircle2 className="size-4" />
            تم تطبيق كود الخصم {promoResult.code}. السعر النهائي ظاهر في الملخص بالأسفل.
          </div>
        ) : null}
      </CardContent>
    </Card>
